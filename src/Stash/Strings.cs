...
public static class L
{
    ...
    public static readonly Dictionary<string, string> Es = new()
    {
        ...
        ["Stop"] = "Detener", ["Stopping after the current file…"] = "Deteniendo tras el archivo actual…", ["No key."] = "Sin clave.",
        ["{0}: not reachable, skipped."] = "{0}: no disponible, omitido.", ["{0}: {1} of {2} files"] = "{0}: {1} de {2} archivos",
        ["{0}: stopped; pieces already uploaded will be reused next time."] = "{0}: detenido; las piezas ya subidas se reutilizarán la próxima vez.",
        ["{0}: {1} files, uploaded {2}, reused {3} pieces"] = "{0}: {1} archivos, subidos {2}, reutilizadas {3} piezas", [", {0} unchanged and not reread"] = ", {0} sin cambios y no releídos",
        [", {0} cloud placeholders listed not downloaded"] = ", {0} marcadores en la nube listados, no descargados", [", {0} unreadable"] = ", {0} ilegibles", [", reclaimed {0}"] = ", recuperados {0}", [" in {0:0.0} s."] = " en {0:0.0} s.",
        ["{0}: checking {1} of {2} pieces"] = "{0}: comprobando {1} de {2} piezas", ["{0}: stopped."] = "{0}: detenido.", ["{0}: {1} pieces open"] = "{0}: {1} piezas abiertas",
        [", {0} in the cloud only"] = ", {0} solo en la nube", [", {0} damaged"] = ", {0} dañadas", [", {0} missing"] = ", {0} ausentes",
        ["; {0} restored and identical to the original"] = "; {0} restaurado e idéntico al original", ["; {0} restored and matched"] = "; {0} restaurado y coincide", ["; {0} did NOT restore correctly"] = "; {0} NO se restauró correctamente",
        ["No destination reachable."] = "Ningún destino disponible.", ["restoring {0} of {1} files"] = "restaurando {0} de {1} archivos",
        ["Restored {0} files ({1}) into {2}."] = "Restaurados {0} archivos ({1}) en {2}.", [" Stopped before the end."] = " Detenido antes del final.", [" {0} failed: {1}"] = " {0} fallaron: {1}",
        ["Read every file every time, instead of trusting size and modified time for unchanged files (slower, thorough)"] = "Leer cada archivo cada vez, en lugar de confiar en el tamaño y la fecha de los archivos sin cambios (más lento, exhaustivo)",
        ["Run even when I am not signed in"] = "Ejecutar aunque no haya iniciado sesión",
        ["A Task Scheduler task for this user runs the backup whether or not the window is open, only to destinations that are reachable, uploading only what changed. A missed run happens when the PC is next awake; running on battery is allowed."] = "Una tarea del Programador de tareas para este usuario hace la copia esté o no abierta la ventana, solo a los destinos disponibles, subiendo solo lo que cambió. Una ejecución perdida se hace cuando el PC vuelve a estar despierto; se permite con batería.",
        ["Normally the schedule runs while you are signed in, locked screen included, and the key is protected for your account. With this on, Task Scheduler runs it with nobody signed in too, without storing your password; to make that possible the key is protected for this PC instead, which an administrator on this PC could read. Cloud folders only sync once you sign in; a disk or a NAS gets the backup right away."] = "Normalmente la programación se ejecuta con la sesión iniciada, pantalla bloqueada incluida, y la clave está protegida para tu cuenta. Con esto activado, el Programador de tareas la ejecuta también sin nadie conectado, sin guardar tu contraseña; para que sea posible la clave se protege para este PC, y un administrador de este PC podría leerla. Las carpetas en la nube solo sincronizan cuando inicias sesión; un disco o un NAS recibe la copia de inmediato.",
