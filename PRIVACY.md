...
Settings (which folders, which destinations, the schedule) are a plain JSON file in the same folder. `stash.log` records when backups ran and whether they succeeded, nothing about file contents.
